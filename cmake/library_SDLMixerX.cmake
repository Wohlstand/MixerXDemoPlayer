...
set(MIXER_USE_LIBFLAC OFF)
set(MIXER_USE_DRFLAC ON)
set(MIXER_USE_DRMP3 ON)
set(MIXER_USE_MPG123 OFF)

if(NINTENDO_3DS)
    set(MIXER_USE_LIBFLAC ON)
    set(MIXER_USE_DRFLAC OFF)
    set(MIXER_USE_OGG_VORBIS_FILE OFF)
    set(MIXER_USE_OGG_VORBIS_STB OFF)
    set(MIXER_USE_OGG_VORBIS_TREMOR ON)
    set(MIXER_USE_DRMP3 OFF)
    set(MIXER_USE_MPG123 ON)
endif()
...
if(MIXER_USE_MPG123)
    list(APPEND MixerX_CodecLibs "${AC_MPG123}")
endif()

if(MIXER_USE_LIBFLAC)
    list(APPEND MixerX_CodecLibs "${AC_FLAC}")
endif()
...
if(THEXTECH_NO_MIXER_X)
    ...
    if(NOT NINTENDO_3DS)
        list(APPEND AUDIO_CODECS_BUILD_ARGS
            "-DBUILD_GME=OFF"
            "-DBUILD_OGG_VORBIS=${MIXER_USE_OGG_VORBIS_FILE}"
        )
    endif()
else()
    list(APPEND AUDIO_CODECS_BUILD_ARGS
        "-DBUILD_FLAC=${MIXER_USE_LIBFLAC}"
        "-DBUILD_MPG123=${MIXER_USE_MPG123}"
        "-DBUILD_GME_SYSTEM_ZLIB=${USE_SYSTEM_ZLIB}"
        "-DBUILD_WAVPACK=${MIXERX_ENABLE_WAVPACK}"
    )
    if(MIXER_USE_OGG_VORBIS_TREMOR OR MIXER_USE_OGG_VORBIS_FILE)
        list(APPEND AUDIO_CODECS_BUILD_ARGS "-DBUILD_OGG_VORBIS=ON")
    else()
        list(APPEND AUDIO_CODECS_BUILD_ARGS "-DBUILD_OGG_VORBIS=OFF")
    endif()
...
if(NOT THEXTECH_NO_MIXER_X)
    ...
    #    UPDATE_COMMAND ""
        ...
        CMAKE_ARGS
            ...
            "-DUSE_DRFLAC=${MIXER_USE_DRFLAC}"
            "-DUSE_FLAC=${MIXER_USE_LIBFLAC}"
            ...
            "-DUSE_MP3_DRMP3=${MIXER_USE_DRMP3}"
            "-DUSE_MP3_MPG123=${MIXER_USE_MPG123}"
